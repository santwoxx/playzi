...
import { X, Send, Lock, EyeOff, MessageSquare, ChevronRight, Clock, Globe } from 'lucide-react';
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-3 no-scrollbar">
               ...
               <button 
                  ...
                  className="w-full vibe-card p-4 flex items-center space-x-4 border-vibe-neon-blue/30 bg-vibe-neon-blue/5 hover:neon-border transition-all text-left"
               >
                  <div className="w-12 h-12 rounded-xl bg-vibe-neon-blue flex items-center justify-center shadow-[0_0_15px_rgba(0,242,255,0.3)]">
                     <Globe className="w-6 h-6 text-white animate-pulse" />
                  </div>
                  <div className="flex-1">
                     <div className="flex items-center space-x-2">
                        <h4 className="text-xs font-black text-white uppercase tracking-tighter">Chat Global</h4>
                        <div className="w-2 h-2 rounded-full bg-vibe-neon-blue animate-ping" />
                     </div>
                     <p className="text-[10px] text-vibe-neon-blue font-bold uppercase tracking-tight opacity-70">Sempre Aberto • Todos Online</p>
                  </div>
               </button>
